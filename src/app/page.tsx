  ...
  return (
    <Layout>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 md:px-6 py-6 md:py-10 lg:px-20 z-10 relative">
        <h1 className="sr-only">XP Fortnite: Calculadora de Progressão</h1>
        <Hero onCalculate={calculate} isCalculated={calculated} />
        ...
        <section className="mt-8 space-y-12 animate-reveal delay-300">
          ...
          <article className="space-y-10">
            <div className="text-center max-w-3xl mx-auto space-y-4 mb-10">
              <h2 className="text-3xl md:text-5xl font-black text-white uppercase italic tracking-tighter">
                {t.guide.howTo.split("?")[0]}{" "}
                <span className="text-primary">XP Fortnite</span>?
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="bg-card-dark/40 border border-border-dark p-6 rounded-2xl space-y-4 hover:border-primary/30 transition-all group"
                >
                  ...
                  <div className="space-y-2">
                    <h4 className="text-white font-black text-lg uppercase italic tracking-tight">
                      {step.title}
                    </h4>
          ...
          <article className="space-y-8 animate-reveal delay-500">
            <div className="text-center max-w-3xl mx-auto space-y-4">
              <h2 className="text-3xl md:text-5xl font-black text-white uppercase italic tracking-tighter">
                {t.strategies.maximize.replace("XP Fortnite", "")}{" "}
                <span className="text-primary">XP Fortnite</span>
              </h2>
              <p className="text-slate-400">{t.strategies.maximizeDesc}</p>
            </div>
